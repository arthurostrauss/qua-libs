    ...
    with for_(n, 0, n < N_shots, n + 1):
        ...
        with for_(i_tau, 0, i_tau < num_taus, i_tau + 1):
            ...
            with for_(i_echo, 0, i_echo < numecho_array_q[i_tau], i_echo + 1):
                ...
                measure('readout', 'resonator', None, dual_demod.full('cos', 'out1', 'sin', 'out2', I),
...
if simulate:
    ...
    simulate_config = SimulationConfig(duration=1000, include_analog_waveforms=True, include_digital_waveforms=True,
